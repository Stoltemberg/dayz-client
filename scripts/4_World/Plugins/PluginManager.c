...
{	
	...
	{	
		...
		RegisterPlugin( "PluginAdmin",						true, 	true, 	true );
		RegisterPlugin( "PluginCustomChat",					true, 	true, 	true );
		RegisterPlugin( "PluginParty",						true, 	true, 	true );
		RegisterPlugin( "PluginSpawnSelector",				true, 	true, 	true );
		RegisterPlugin( "PluginRecipesManager",				true, 	true, 	false );
		...
		RegisterPlugin( "PluginObjectsInteractionManager",	false, 	true, 	false );
