...
const int MENU_ADMIN								= 16777216;
const int MENU_PARTY								= 33554432;
const int MENU_SPAWN_SELECTOR						= 67108864;
...
const int DEV_RPC_DEBUG_PING					= 112;
const int DEV_RPC_SET_HUD_TEST_HUNGER			= 113;
const int DEV_RPC_SET_HUD_TEST_STATUS			= 114;
/** @}*/

/**
 * \defgroup Admin RPC commands
 * \desc Constants for the server-authorized admin panel.
 * @{
 */
const int ADMIN_RPC_AUTH_REQUEST					= 201;
const int ADMIN_RPC_AUTH_RESPONSE					= 202;
const int ADMIN_RPC_PLAYER_LIST_REQUEST			= 203;
const int ADMIN_RPC_PLAYER_LIST_RESPONSE			= 204;
const int ADMIN_RPC_COMMAND						= 205;
const int ADMIN_RPC_MESSAGE						= 206;
/** @}*/

/**
 * \defgroup Custom chat RPC commands
 * \desc Server-routed chat channels with UID based tags.
 * @{
 */
const int CHAT_RPC_SEND							= 301;
const int CHAT_RPC_DELIVER						= 302;
/** @}*/

/**
 * \defgroup Party RPC commands
 * \desc Clan/party menu, invites and member sync.
 * @{
 */
const int PARTY_RPC_COMMAND						= 401;
const int PARTY_RPC_STATE							= 402;
const int PARTY_RPC_MESSAGE						= 403;
/** @}*/

/**
 * \defgroup Spawn selector RPC commands
